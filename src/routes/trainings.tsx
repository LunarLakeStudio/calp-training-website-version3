                ...
                >
                  ...
                  <div className="mt-auto flex gap-2">
                    <Link
                      ...
                      className="flex-1 rounded-lg border border-calp-blue/15 px-4 py-2 text-center text-xs font-bold uppercase tracking-widest text-calp-blue transition-colors hover:border-calp-blue"
                    >
                      Details
                    </Link>
                    <Link
                      ...
                      className="flex-1 rounded-lg bg-calp-blue px-4 py-2 text-center text-xs font-bold uppercase tracking-widest text-white transition-colors group-hover:bg-calp-red"
                    >
                      Apply
                    </Link>
                  </div>
