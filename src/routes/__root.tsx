  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-calp-canvas px-4">
      <div className="max-w-md text-center">
        <h1 className="font-display text-7xl font-bold text-calp-navy">404</h1>
        <h2 className="mt-4 text-xl font-semibold text-calp-navy">Page not found</h2>
        <p className="mt-2 text-sm text-calp-slate">
          The page you're looking for doesn't exist or has been moved.
        </p>
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-calp-navy px-5 py-2 text-sm font-semibold text-white transition-colors hover:bg-calp-red"
          >
            Go home
          </Link>
        </div>
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-calp-canvas px-4">
      <div className="max-w-md text-center">
        <h1 className="font-display text-xl font-semibold tracking-tight text-calp-navy">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-full border border-calp-navy/20 bg-white px-5 py-2 text-sm font-semibold text-calp-navy transition-colors hover:bg-calp-canvas"
          >
            Go home
          </a>
        </div>
