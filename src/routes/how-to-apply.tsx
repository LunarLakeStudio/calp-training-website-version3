  ...
  return (
    <>
      <section className="relative overflow-hidden">
        <ShapeClusterCool className="-left-48 -top-20 -z-10 h-[130%] w-[22rem] opacity-60" />
        <ShapeClusterWarm className="-right-40 -bottom-16 -z-10 h-[120%] w-[22rem] opacity-70" />
        <AnimatedPageHero
      ...
      <section className="relative mx-auto max-w-7xl px-6 pb-24">
        ...
        <ScrollReveal>
          <div className="relative mt-8">
            <ShapeClusterCool className="-left-24 -top-16 -z-10 h-64 w-64 opacity-60" />
            <ShapeClusterWarm className="-bottom-16 -right-24 -z-10 h-64 w-64 opacity-70" />
            <div className="relative rounded-2xl border border-calp-blue/5 bg-white p-6 shadow-sm">
