...
export function TrainingCard({
  ...
  return (
    <article className="group flex h-full flex-col rounded-2xl border border-calp-blue/10 bg-white p-6 shadow-sm transition-all hover:-translate-y-1 hover:border-calp-red/40 hover:shadow-lg">
      ...
      <div className="mt-auto flex flex-wrap gap-2">
        ...
        <Link
          ...
          className="flex-1 rounded-lg bg-calp-red px-4 py-2 text-center text-xs font-bold text-white transition-colors hover:bg-calp-blue"
        >
          {applyLabel}
        </Link>
      </div>
