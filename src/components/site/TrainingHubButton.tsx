...
export function TrainingHubButton({
  ...
  const base = isButton
    ? "inline-flex items-center justify-center gap-1.5 rounded-md border border-calp-blue/20 bg-white px-5 py-2.5 text-sm font-medium text-calp-blue transition-opacity"
