...
export function TrainingHubButton({
  ...
  const base = isButton
    ? "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md bg-calp-blue px-5 py-2.5 text-base font-medium text-white transition-opacity focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-calp-blue focus-visible:ring-offset-2"
