  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-4">
        <h3 className="mb-3 font-display text-base font-bold leading-snug text-calp-blue transition-colors group-hover:text-calp-blue">
          {course.title}
        </h3>
        ...
        <div className="flex items-end justify-between gap-3">
          ...
          <span
            aria-hidden
            className="grid h-9 w-9 shrink-0 place-items-center rounded-md border border-calp-blue/30 text-calp-blue transition-colors group-hover:border-calp-blue group-hover:text-calp-blue"
          >
